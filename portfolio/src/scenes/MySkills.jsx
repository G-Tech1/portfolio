      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        >
          ...
          {/* <p className="mt-10 mb-7">
            ...
            Assembly, C++ Frameworks: Django, React, Bootstrap DevOps and Tools:
            Docker, Git, REST API, Insomnia, Redux Toolkit, RabbitMQ, CI/CD,
            Arduino, Autodesk System Design: Microservices, Monoliths,
            Domain-driven design, Blockchain Databases: SQLite, PostgreSQL
          </p> */}
        </motion.div>
